...
;; Helper function to byte-compile config
(defun jt/byte-compile-config ()
  "Byte-compile the config.org file."
  (interactive)
  (byte-compile-file (expand-file-name "config.el" user-emacs-directory))
  (message "Config byte-compiled successfully!"))
#+end_src
...
;; To switch back to Fleet theme, uncomment: (load-theme 'fleet-ghostty t)
#+end_src
