...
(setq doom-font (font-spec :family "Monaspace Krypton Var" :size 18.0 :height 110 :weight 'medium)
      doom-variable-pitch-font (font-spec :family "Ubuntu" :size 18.0 :height 110 :weight 'medium)
      doom-big-font (font-spec :family "Monaspace Krypton Var" :size 22.0 :height 110 :weight 'medium))

(add-to-list 'default-frame-alist '(font . "Monaspace Krypton Var-16"))
