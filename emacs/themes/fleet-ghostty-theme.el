...
(let ((bg              "#18191B")  ; Official Fleet Dark background
  ...
  (custom-theme-set-faces
   ...
   `(doom-modeline-buffer-major-mode    ((t (:foreground ,green :weight bold))))
   ...
   `(doom-modeline-warning              ((t (:foreground ,yellow-warning))))
   `(doom-modeline-urgent               ((t (:foreground ,red-error :weight bold))))
   ...
   `(doom-modeline-lsp-success          ((t (:foreground ,green-success))))
   `(doom-modeline-lsp-error            ((t (:foreground ,red-error))))
   `(doom-modeline-lsp-warning          ((t (:foreground ,yellow-warning))))
