...
-- This is the xmonad configuration of Jon Tsiros (Hat tip to DT from DistroTube)
-- My Github:  http://www.github.com/jtsiros/
...
myBookmarks = [ ("DistroTube.com", myBrowser ++ "https://www.distrotube.com", "Official website for DistroTube")
              ...
              , ("Github", myBrowser ++ "https://github.com/jtsiros", "GitLab Page for JT")
              , ("Reddit", myBrowser ++ "https://www.reddit.com/r/distrotube/", "r/DistroTube")
              ]

myConfigs :: [(String, String, String)]
myConfigs = [ ("config.fish", myEditor ++ "/home/jtsiros/.config/fish/config.fish", "the fish shell")
            , ("xmonad.hs", myEditor ++ "/home/jtsiros/.xmonad/xmonad.hs", "xmonad config")
            , ("xmobar0", myEditor ++ "/home/jtsiros/.xmobar/xmobarrc0", "xmobar0 config")
            , ("xmobar1", myEditor ++ "/home/jtsiros/.xmobar/xmobarrc1", "xmobar1 config")
            ]
...
main = do
    ...
    xmproc0 <- spawnPipe "xmobar -x 0 /home/jtsiros/.config/xmobar/xmobarrc0"
    xmproc1 <- spawnPipe "xmobar -x 1 /home/jtsiros/.config/xmobar/xmobarrc1"
    xmonad $ ewmh def
